...
![image-20220704202453482](.images_g10_索引优化与查询优化/image-20220704202453482.png)
...
![image-20220704204140589](.images_g10_索引优化与查询优化/image-20220704204140589.png)
...
![image-20220704211116351](.images_g10_索引优化与查询优化/image-20220704211116351.png)
...
![image-20220704211254581](.images_g10_索引优化与查询优化/image-20220704211254581.png)
...
![image-20220704212354041](.images_g10_索引优化与查询优化/image-20220704212354041.png)

如果此时再插入一条主键值为 9 的记录，那它插入的位置就如下图：

![image-20220704212428607](.images_g10_索引优化与查询优化/image-20220704212428607.png)
...
4. 第二种：索引优化失效
   ...
   ![image-20220704214905412](.images_g10_索引优化与查询优化/image-20220704214905412.png)
...
![image-20220704215159768](.images_g10_索引优化与查询优化/image-20220704215159768.png)
...
- student表的字段name上设置有索引
  ...
  ![image-20220704215533871](.images_g10_索引优化与查询优化/image-20220704215533871.png)
...
- 索引优化生效
  ...
  ![image-20220704215600507](.images_g10_索引优化与查询优化/image-20220704215600507.png)
...
![image-20220704215658526](.images_g10_索引优化与查询优化/image-20220704215658526.png)
...
![image-20220704215721216](.images_g10_索引优化与查询优化/image-20220704215721216.png)
...
![image-20220704220123647](.images_g10_索引优化与查询优化/image-20220704220123647.png)
...
![image-20220704223211981](.images_g10_索引优化与查询优化/image-20220704223211981.png)
...
![image-20220704224552374](.images_g10_索引优化与查询优化/image-20220704224552374.png)
...
![image-20220704224916117](.images_g10_索引优化与查询优化/image-20220704224916117.png)
...
![image-20220704225333199](.images_g10_索引优化与查询优化/image-20220704225333199.png)
...
![image-20220705131643304](.images_g10_索引优化与查询优化/image-20220705131643304.png)
...
![image-20220705131717329](.images_g10_索引优化与查询优化/image-20220705131717329.png)
...
![image-20220705132221045](.images_g10_索引优化与查询优化/image-20220705132221045.png)
...
![image-20220705132239232](.images_g10_索引优化与查询优化/image-20220705132239232.png)
...
![image-20220705145225852](.images_g10_索引优化与查询优化/image-20220705145225852.png)
...
![image-20220705160504018](.images_g10_索引优化与查询优化/image-20220705160504018.png)
...
![image-20220705160935109](.images_g10_索引优化与查询优化/image-20220705160935109.png)
...
![image-20220705161243838](.images_g10_索引优化与查询优化/image-20220705161243838.png)
...
![image-20220705161515545](.images_g10_索引优化与查询优化/image-20220705161515545.png)
...
![image-20220705161602362](.images_g10_索引优化与查询优化/image-20220705161602362.png)
...
![image-20220705161746184](.images_g10_索引优化与查询优化/image-20220705161746184.png)
...
![image-20220705161843558](.images_g10_索引优化与查询优化/image-20220705161843558.png)
...
![image-20220705161929544](.images_g10_索引优化与查询优化/image-20220705161929544.png)
...
![image-20220705162009145](.images_g10_索引优化与查询优化/image-20220705162009145.png)
...
![image-20220705163833445](.images_g10_索引优化与查询优化/image-20220705163833445.png)
...
![image-20220705165559127](.images_g10_索引优化与查询优化/image-20220705165559127.png)

可以看到这种方式效率是非常低的，以上述表A数据100条，表B数据1000条计算，则A*B=10万次。开销统计如下:

![image-20220705165646252](.images_g10_索引优化与查询优化/image-20220705165646252.png)
...
![image-20220705172315554](.images_g10_索引优化与查询优化/image-20220705172315554.png)

驱动表中的每条记录通过被驱动表的索引进行访问，因为索引查询的成本是比较固定的，故mysql优化器都倾向于使用记录数少的表作为驱动表（外表）。

![image-20220705172650749](.images_g10_索引优化与查询优化/image-20220705172650749.png)

如果被驱动表加索引，效率是非常高的，但如果索引不是主键索引，所以还得进行一次回表查询。相比，被驱动表的索引是主键索引，效率会更高。

#### 4. Block Nested-Loop Join（块嵌套循环连接）

![image-20220705173047234](.images_g10_索引优化与查询优化/image-20220705173047234.png)
...
![image-20220705174005280](.images_g10_索引优化与查询优化/image-20220705174005280.png)

![image-20220705174250551](.images_g10_索引优化与查询优化/image-20220705174250551.png)
...
![image-20220705205050280](.images_g10_索引优化与查询优化/image-20220705205050280.png)
...
![image-20220705210708343](.images_g10_索引优化与查询优化/image-20220705210708343.png)
...
![image-20220705210839437](.images_g10_索引优化与查询优化/image-20220705210839437.png)
...
![image-20220705215436102](.images_g10_索引优化与查询优化/image-20220705215436102.png)

**过程二： order by 时不limit,索引失效**

![image-20220705215909350](.images_g10_索引优化与查询优化/image-20220705215909350.png)

**过程三：order by 时顺序错误，索引失效**

![image-20220705220033520](.images_g10_索引优化与查询优化/image-20220705220033520.png)

**过程四：order by 时规则不一致，索引失效（顺序错，不索引；方向反，不索引）**

![image-20220705220404802](.images_g10_索引优化与查询优化/image-20220705220404802.png)

> 结论：ORDER BY 子句，尽量使用 Index 方式排序，避免使用 FileSort 方式排序

**过程五：无过滤，不索引**

![image-20220705221212879](.images_g10_索引优化与查询优化/image-20220705221212879.png)
...
![image-20220705222027812](.images_g10_索引优化与查询优化/image-20220705222027812.png)
...
![image-20220705222912521](.images_g10_索引优化与查询优化/image-20220705222912521.png)

这样我们优化掉了 using filesort

查询结果如下：

![image-20220705222954971](.images_g10_索引优化与查询优化/image-20220705222954971.png)
...
![image-20220705223111883](.images_g10_索引优化与查询优化/image-20220705223111883.png)
...
![image-20220705223329164](.images_g10_索引优化与查询优化/image-20220705223329164.png)
...
![image-20220705224410340](.images_g10_索引优化与查询优化/image-20220705224410340.png)

**2. 尝试提高 max_length_for_sort_data**

![image-20220705224505668](.images_g10_索引优化与查询优化/image-20220705224505668.png)

**3. Order by 时select \* 是一个大忌。最好只Query需要的字段。**

![image-20220705224551104](.images_g10_索引优化与查询优化/image-20220705224551104.png)
...
![image-20220705225329130](.images_g10_索引优化与查询优化/image-20220705225329130.png)
...
![image-20220705225625166](.images_g10_索引优化与查询优化/image-20220705225625166.png)
...
![image-20220705225654124](.images_g10_索引优化与查询优化/image-20220705225654124.png)
...
![image-20220706124528680](.images_g10_索引优化与查询优化/image-20220706124528680.png)
...
![image-20220706124612180](.images_g10_索引优化与查询优化/image-20220706124612180.png)
...
![image-20220706125113658](.images_g10_索引优化与查询优化/image-20220706125113658.png)
...
![image-20220706125351116](.images_g10_索引优化与查询优化/image-20220706125351116.png)

### 8.2 覆盖索引的利弊

![image-20220706125943936](.images_g10_索引优化与查询优化/image-20220706125943936.png)
...
![image-20220706130901307](.images_g10_索引优化与查询优化/image-20220706130901307.png)

以及

![image-20220706130921934](.images_g10_索引优化与查询优化/image-20220706130921934.png)
...
![image-20220706131320477](.images_g10_索引优化与查询优化/image-20220706131320477.png)
...
![image-20220706135436316](.images_g10_索引优化与查询优化/image-20220706135436316.png)

![image-20220706135506409](.images_g10_索引优化与查询优化/image-20220706135506409.png)

- 主键索引 (简图)

![image-20220706135633814](.images_g10_索引优化与查询优化/image-20220706135633814.png)

二级索引zip_last_first (简图，这里省略了数据页等信息)

![image-20220706135701187](.images_g10_索引优化与查询优化/image-20220706135701187.png)

![image-20220706135723203](.images_g10_索引优化与查询优化/image-20220706135723203.png)

### 10.4 开启和关闭ICP性能对比

![image-20220706135904713](.images_g10_索引优化与查询优化/image-20220706135904713.png)

![image-20220706140213382](.images_g10_索引优化与查询优化/image-20220706140213382.png)
...
![image-20220706141957185](.images_g10_索引优化与查询优化/image-20220706141957185.png)
...
![image-20220706142648452](.images_g10_索引优化与查询优化/image-20220706142648452.png)
...
![image-20220706151506580](.images_g10_索引优化与查询优化/image-20220706151506580.png)
...
![image-20220706151715106](.images_g10_索引优化与查询优化/image-20220706151715106.png)
...
![image-20220706161436920](.images_g10_索引优化与查询优化/image-20220706161436920.png)
...
![image-20220706162131362](.images_g10_索引优化与查询优化/image-20220706162131362.png)
...
![image-20220706162657448](.images_g10_索引优化与查询优化/image-20220706162657448.png)
...
![image-20220706162947613](.images_g10_索引优化与查询优化/image-20220706162947613.png)
