...
![image-20220621202759576](.images_g08_索引的创建与设计原则/image-20220621202759576.png)

**2. 唯一性索引**

![image-20220621202850551](.images_g08_索引的创建与设计原则/image-20220621202850551.png)

**3. 主键索引**

![image-20220621203302303](.images_g08_索引的创建与设计原则/image-20220621203302303.png)

**4. 单列索引**

![image-20220621203333925](.images_g08_索引的创建与设计原则/image-20220621203333925.png)

**5. 多列 (组合、联合) 索引**

![image-20220621203454424](.images_g08_索引的创建与设计原则/image-20220621203454424.png)

**6. 全文检索**

![image-20220621203645789](.images_g08_索引的创建与设计原则/image-20220621203645789.png)

**7. 补充：空间索引**

![image-20220621203736098](.images_g08_索引的创建与设计原则/image-20220621203736098.png)
...
![image-20220622224124267](.images_g08_索引的创建与设计原则/image-20220622224124267.png)

从结果可以看出，索引仍然是默认的升序

在MySQL 8.0版本中查看数据表ts1的结构，结果如下：

![image-20220622224205048](.images_g08_索引的创建与设计原则/image-20220622224205048.png)
...
![image-20220623154615702](.images_g08_索引的创建与设计原则/image-20220623154615702.png)
...
![image-20220623175306282](.images_g08_索引的创建与设计原则/image-20220623175306282.png)

#### 8. 使用字符串前缀创建索引

![image-20220623175513439](.images_g08_索引的创建与设计原则/image-20220623175513439.png)
...
![image-20220627151947786](.images_g08_索引的创建与设计原则/image-20220627151947786.png)
