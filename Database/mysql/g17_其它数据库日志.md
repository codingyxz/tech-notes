...
<img src=".images_g17_其他数据库日志/image-20220715141705004-7514259.png" alt="image-20220715141705004" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715145650406-7514259.png" alt="image-20220715145650406" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715155010381-7514259.png" alt="image-20220715155010381" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715160249271-7514259.png" alt="image-20220715160249271" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715160657093-7514259.png" alt="image-20220715160657093" style="float:left;" />
...
* 第二步：重建日志
  ...
  ![image-20220715161132368](.images_g17_其他数据库日志/image-20220715161132368-7514259.png)
...
<img src=".images_g17_其他数据库日志/image-20220715161216556-7514259.png" alt="image-20220715161216556" style="float:left;" />

### 4.4 MySQL 8.0 新特性

<img src=".images_g17_其他数据库日志/image-20220715161321565-7514259.png" alt="image-20220715161321565" style="float:left;" />
...
binlog主要应用场景：
  ...
  <img src=".images_g17_其他数据库日志/image-20220715161800635-7514259.png" alt="image-20220715161800635" style="zoom:100%;" />

![image-20220715161842703](.images_g17_其他数据库日志/image-20220715161842703-7514259.png)
...
<img src=".images_g17_其他数据库日志/image-20220715163520596-7514259.png" alt="image-20220715163520596" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715163811664-7514259.png" alt="image-20220715163811664" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715164107352-7514259.png" alt="image-20220715164107352" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715164718970-7514259.png" alt="image-20220715164718970" style="float:left;" />

<img src=".images_g17_其他数据库日志/image-20220715164743351-7514259.png" alt="image-20220715164743351" style="float:left;" />

<img src=".images_g17_其他数据库日志/image-20220715164809401-7514259.png" alt="image-20220715164809401" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715165603879-7514259.png" alt="image-20220715165603879" style="float:left;" />
...
<img src=".images_g17_其他数据库日志/image-20220715171712026-7514259.png" alt="image-20220715171712026" style="float:left;" />

<img src=".images_g17_其他数据库日志/image-20220715172015185-7514259.png" alt="image-20220715172015185" style="float:left;" />

**2. RESET MASTER: 删除所有二进制日志文件**

<img src=".images_g17_其他数据库日志/image-20220715172104967-7514259.png" alt="image-20220715172104967" style="float:left;" />
...
![image-20220715172958729](.images_g17_其他数据库日志/image-20220715172958729-7514259.png)
...
![image-20220715193749462](.images_g17_其他数据库日志/image-20220715193749462-7514259.png)

为了安全起见，可以设置为 `1` ，表示每次提交事务都会执行fsync，就如同**redo log 刷盘流程**一样。 最后还有一种折中方式，可以设置为N(N>1)，表示每次提交事务都write，但累积N个事务后才fsync。

![image-20220715194624080](.images_g17_其他数据库日志/image-20220715194624080-7514259.png)
...
![image-20220715194959405](.images_g17_其他数据库日志/image-20220715194959405-7514259.png)
...
![image-20220715195016492](.images_g17_其他数据库日志/image-20220715195016492-7514259.png)

由于binlog没写完就异常，这时候binlog里面没有对应的修改记录。因此，之后用binlog日志恢复数据时，就会少这一次更新，恢复出来的这一行c值为0，而原库因为redo log日志恢复，这一行c的值是1，最终数据不一致。

![image-20220715195521986](.images_g17_其他数据库日志/image-20220715195521986-7514259.png)

为了解决两份日志之间的逻辑一致问题，InnoDB存储引擎使用**两阶段提交**方案。原理很简单，将redo log的写入拆成了两个步骤prepare和commit，这就是**两阶段提交**。

![image-20220715195635196](.images_g17_其他数据库日志/image-20220715195635196-7514259.png)

使用两阶段提交后，写入binlog时发生异常也不会有影响，因为MySQL根据redo log日志恢复数据时，发现redo log还处于prepare阶段，并且没有对应binlog日志，就会回滚该事务。

![image-20220715200248193](.images_g17_其他数据库日志/image-20220715200248193-7514259.png)

另一个场景，redo log设置commit阶段发生异常，那会不会回滚事务呢？

![image-20220715200321717](.images_g17_其他数据库日志/image-20220715200321717-7514259.png)
